...
// DOM要素
const passwordDisplay = getElement('password');
const lengthSlider = getElement('lengthSlider');
...
const symbolsCheckbox = getElement('symbols');
 ...
 * 強度インジケーターを更新
 */
const updateStrengthIndicator = (password, options) => {
 ...
 * 強度に応じた色を取得
 */
const getStrengthColor = (className) => {
  const colors = {
