          ...
          {formStatus === 'success' ? (
            ...
            <form onSubmit={handleSubmit} className="mx-auto max-w-lg space-y-4">
              ...
              <div className="flex flex-col items-center gap-4 pt-2 sm:flex-row sm:justify-center">
                <button
                  ...
                  className="inline-flex items-center justify-center gap-2 rounded-full border border-zinc-200 bg-white px-8 py-3 text-sm font-medium text-zinc-900 shadow-sm transition-all duration-300 hover:bg-zinc-100 active:scale-95 disabled:cursor-not-allowed disabled:opacity-60"
                >
            ...
            <div className="flex flex-col items-center justify-center gap-4 md:flex-row">
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-2 rounded-full border border-zinc-200 bg-white px-8 py-3.5 text-sm font-medium text-zinc-900 shadow-sm transition-all duration-300 hover:bg-zinc-100 active:scale-95"
              >
